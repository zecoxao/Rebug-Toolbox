...
#define HVSC_SYSCALL_ADDR_481D		0x80000000002BC1D4ULL	// where above syscall is in lv2 4.81 DEX
...
#define NEW_POKE_SYSCALL_ADDR_481D	0x80000000002BC6FCULL   // where above syscall is in lv2 4.81 DEX
...
#define SYSCALL_TABLE_480D			0x800000000038A4E8ULL	// 4.80 DEX , TOC : 0x3759B0 4.81 DEX, TOC 0x3759C0
